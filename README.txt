...
taking advantage of these words to build off words that are already played. If you are unsure wether the computer played a 
...
3) In the folder containg the above files run the command python3 scrabble.py if you
...
select tiles from the "bag of tiles" where the letter of the tile was the key and the number of occurences of the tile in 
